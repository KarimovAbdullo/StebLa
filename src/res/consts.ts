...
export const API_PATH_RULES = '/orchestry/api/v1/tg/track-word'
export const API_PATH_RULES_lIST = '/orchestry/api/v1/tg/track-word'
export const API_PATH_TELEGRAM_INIT = '/bot-telegram-service/public/init'
export const API_PATH_PAYMENT = '/payment-back/api/v1/createPayment'
export const API_PATH_RULES_GROUPS = '/orchestry/api/v1/tg/groups'
export const API_PATH_RULES_STATICS = '/orchestry/api/v1/tg/statistics'
